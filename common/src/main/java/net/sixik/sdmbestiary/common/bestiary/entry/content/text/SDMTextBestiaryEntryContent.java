...
public class SDMTextBestiaryEntryContent extends AbstractBestiaryEntryContent {
    ...
    public SDMTextBestiaryEntryContent(AbstractBestiaryEntry bestiaryEntry) {
        super(bestiaryEntry);
    }
    ...
    public AbstractBestiaryEntryContentWidgetPanel createWidget(AbstractBestiaryEntryContentPanel contentPanel) {
        return new AbstractBestiaryEntryContentWidgetPanel(contentPanel, this, false) {
            ...
            public void drawBackground(GuiGraphics graphics, Theme theme, int x, int y, int w, int h) {
                ...
                d2 += text_y_offset;
                if (isCentered_x) {
                    int h1 = TextHelper.getTextWidth(text);
                    d1 = w / 3 + h1 / 2;
                    d1 = x + d1;
                }
            ...
            public void setProperty() {
                ...
                if(renderSettings.autoSize) {
                    setSize(content.renderSettings.size.x, (int) (content.renderSettings.size.y * (content.renderSettings.scale)));
                }
            }
        };
    }
    ...
    public void deserializeNBT(CompoundTag nbt) {
        ...
        this.text_x_offset = nbt.getInt("text_x_offset");
    ...
    public static class Construct implements IConst<AbstractBestiaryEntryContent> {
        ...
        public AbstractBestiaryEntryContent createDefaultInstance() {
            return new SDMTextBestiaryEntryContent(null);
        }
    }
}
